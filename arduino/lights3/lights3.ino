...
CapacitiveSensor   capsense = CapacitiveSensor(4,6);   
// 10M resistor between pins 4 & 6, pin 6 is sensor pin, add a wire and or foil if desired
...
void handle_touches() {
      ...
      long total1 =  capsense.capacitiveSensor(30);
      Serial.println(total1);                  // print sensor output 1
      touch_state.state = total1/1000;
